...
void student::getdata()
{
	...
	cin.ignore(); // it clears the buffer
	cin.getline(name,50);
...
void write_student();	//writ  e the record in binary file
...
void display_all()
{
	...
	cout<<"\nDISPLAY ALL RECORD !!!";
	while(inFile.read(reinterpret_cast<char *> (&st), sizeof(student))) //loading data in st variable from file
	{
		st.showdata();
		cout<<"\n====================================";
	}
...
void result()
{
	...
	case '2' :	cout<<"\n\n\tEnter Roll Number Of Student : "; cin>>rno; display_sp(rno); break;
	case '3' :	break;
	default:	cout<<"\a";
	}
}
